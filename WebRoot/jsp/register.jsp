...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="<%=request.getContextPath()%>/user/reg.do" method="post">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-10">
			      <input type="button"  width="100" value="注册" name="submit" border="0"
				    ...
				    height:35px;width:100px;color:white;" onclick="reg()">
			    </div>
			  </div>
			</form>
	</div>
			...
			function reg(){
				...
				$.ajax({
					...
					success:function(data){
						if(data=="1"){
							alert("注册成功");
							window.location="<%=request.getContextPath()%>/jsp/login.jsp";  
						}else{
							alert("注册失败");
						}
					}
